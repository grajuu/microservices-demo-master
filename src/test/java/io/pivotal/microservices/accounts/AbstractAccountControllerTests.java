...
public abstract class AbstractAccountControllerTests {
	...
	protected static final String ACCOUNT_1_LOCATION = "Goa";
	...
	public void validAccountNumber() {
		...
		Assert.assertEquals(ACCOUNT_1_LOCATION, account.getLocation());
	...
	@Test
	public void validAccountLocation() {
		Logger.getGlobal().info("Start validLocation test");
		List<Account> accounts = accountController.byLocation(ACCOUNT_1_LOCATION);
		Logger.getGlobal().info("In validLocation test");
		...
		Assert.assertEquals(ACCOUNT_1_NAME, account.getOwner());
		Assert.assertEquals(ACCOUNT_1_LOCATION, account.getLocation());
		Logger.getGlobal().info("End validLocation test");
	}
