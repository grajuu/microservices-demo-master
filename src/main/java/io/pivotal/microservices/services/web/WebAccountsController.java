...
public class WebAccountsController {
	...
	@RequestMapping("/accounts/location/{text}")
	public String byLocation(Model model,@PathVariable("text") String location) {
		logger.info("web-service byLocation() invoked: " + location);
		List<Account> accounts = accountsService.byLocation(location);
		logger.info("web-service byLocation() found: " + accounts);
		model.addAttribute("location", location);
		if (accounts != null)
			model.addAttribute("location", accounts);
